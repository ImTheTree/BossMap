...
public class FriendlyDummy extends EntityVillager {
    private boolean b;
    
    @SuppressWarnings("deprecation")
	public FriendlyDummy(final Location loc) {
        super(EntityTypes.VILLAGER, (World)((CraftWorld)loc.getWorld()).getHandle());
        ...
        this.setCustomName((IChatBaseComponent)new ChatComponentText("§aFreundliche Kampfattrappe [§2§lHP: §2" + this.getHealth() + "/100§a]"));
    }
